...
- The `‹/›` button collapses the left diagnosis panel. At narrow widths the three modality panels automatically become tabs, so the window fits without a left-to-right scrollbar.
