...
QUESTION_START_PAGE = 90
QUESTION_END_PAGE = 131
ANSWER_START_PAGE = 130
ANSWER_END_PAGE = 158
...
def strip_page_noise(text: str) -> str:
    text = re.sub(r"^2 Pediatric Genitourinary Tract Questions\s*", "", text)
...
def split_questions(text: str) -> list[dict]:
    ...
    for i, match in enumerate(matches):
        ...
        body = re.sub(r"(?<=[A-Za-z0-9)])([A-D])\.\s*", r" \1. ", body)
...
<body>
  <header>
    <div class="bar">
      <div>
        <h1>Pediatric Genitourinary Tract Quiz</h1>
      </div>
  ...
  <dialog id="settingsDialog">
    ...
    <div class="settings-body">
      ...
      <div class="settings-field">
        ...
        <textarea id="stateImport" placeholder='{{"version":1,"appId":"pediatric-gu-imaging-quiz-ch2",...}}'></textarea>
      </div>
      <div class="settings-row">
  ...
  <script>
    ...
    const APP_ID = "pediatric-gu-imaging-quiz-ch2";
