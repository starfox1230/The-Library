...
TITLE = "Thoracic Imaging: A Core Review Terms and Signs Quiz"
APP_ID = "thoracic-imaging-core-review-terms-signs-quiz-ch3"
DEFAULT_SEED_VERSION = 1
DEFAULT_SELECTED: dict[str, str] = {}

CHAPTER_FILES = [
    "OEBPS/xhtml/Hobbs9781975126223-ch003.xhtml",
    "OEBPS/xhtml/Hobbs9781975126223-ch003e.xhtml",
]
...
def render_html(questions: list[dict]) -> str:
    ...
    title_pattern = r"(Pediatric GI Imaging Quiz|Pediatric Gastrointestinal Tract Quiz|Thoracic Imaging: A Core Review Normal Anatomy Quiz|Absolute Breast Imaging Review Interventional Procedures Quiz)"
    template = re.sub(title_pattern, TITLE, template)
    id_pattern = r"(pediatric-gi-imaging-quiz-ch1|thoracic-imaging-core-review-normal-anatomy-quiz-ch2|absolute-breast-imaging-review-interventional-procedures-quiz-ch6)"
