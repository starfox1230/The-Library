...
TITLE = "Nuclear Medicine Oncology Quiz"
APP_ID = "nuclear-medicine-oncology-quiz-ch11"

# Zero-based PDF page indexes for chapter 11.
QUESTION_RANGES = [range(386, 407), range(426, 428)]
ANSWER_RANGES = [range(407, 426), range(427, 429)]
...
def is_noise_line(line: str) -> bool:
    ...
    if re.fullmatch(r"\d{1,2}[A-Z]", line):
        return True
    if line in {"QUESTIONS", "ANSWERS AND EXPLANATIONS", "Endocrine System", "Musculoskeletal System", "Head and Neck", "Nuclear Cardiology", "Vascular and Lymphatics", "Pulmonary System", "Gastrointestinal System", "Genitourinary System", "Pediatric Nuclear Medicine", "Oncology"}:
        return True
        ...
        for page_index in page_range:
            for line in page_lines(reader, page_index):
                ...
                if qmatch and not re.fullmatch(r"\d{1,2}", qmatch.group(2)):
                    ...
                    if qid == "11" and "Oncology" in stem:
                        continue
                    flush_question()
