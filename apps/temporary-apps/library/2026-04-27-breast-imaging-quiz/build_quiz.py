...
CHAPTER_FILE = EPUB_DIR / "ch001.xhtml"
ASSET_DIR = APP_DIR / "assets"
MAX_QUESTIONS = 80

LETTERS = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
QUESTION_CLASSES = {"num", "num1", "Questbnum", "Questbnum1"}
...
<head>
  ...
  <title>Breast Imaging Regulatory Quiz</title>
  <style>
    :root {{
      color-scheme: dark;
      --bg: #0f1218;
...
<body>
  <header>
    <div class="bar">
      <div>
        <h1>Breast Imaging Regulatory Quiz</h1>
      </div>
  ...
  <script>
    ...
    const APP_ID = "breast-imaging-regulatory-quiz-ch1";
