...
ADDON_DISPLAY_NAME = "Speed Streak v1.36"
...
class ReviewerOverlayController:
    ...
    def _install_menu(self) -> None:
        ...
        menu.addSeparator()
        whats_new_action = menu.addAction(f"What’s New in {WHATS_NEW_VERSION}")
    ...
    def _load_persisted_settings(self) -> None:
        ...
        try:
            ...
            self.engine.update_gameplay_settings(
                ...
                boost_seconds=float(config.get("boost_seconds", 5)),
                max_boost_charges=int(config.get("max_boost_charges", 3)),
                starting_boost_charges=int(config.get("starting_boost_charges", 1)),
                cards_per_boost_charge=int(config.get("cards_per_boost_charge", 5)),
            )
            self._normalize_feedback_preferences()
