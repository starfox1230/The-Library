(function () {
  ...
  const COLOR_FIELDS = [
    { key: "core", label: "Central Orb", description: "Main orb color and the base for Central Orb Color crystals." },
    { key: "red", label: "Again", description: "Used for Again satellites, timeout effects, and crystal fractures." },
    { key: "yellow", label: "Hard", description: "Used for Hard satellites and Answer Colors crystals." },
    { key: "green", label: "Good", description: "Used for Good satellites and Answer Colors crystals." },
    { key: "blue", label: "Easy", description: "Used for Easy satellites and Answer Colors crystals." },
  ];
          ...
          <div class="acg-modal-body">
            ...
            <div id="acgAppearancePanel" class="acg-panel hidden">
              ...
              <div class="acg-appearance-options">
                ...
                <button id="acgColorCustomizerButton" class="acg-action" type="button">Visual Palette</button>
              </div>
            </div>
            <div id="acgColorPanel" class="acg-color-panel hidden">
              <div class="acg-color-panel-head">
                <div>
                  <div class="acg-modal-title">Visual Palette</div>
                  <div class="acg-panel-copy">Pick the central orb and answer-rating colors used by satellites, crystals, and optional timer fades. Changes preview immediately and save when you hit Save Colors.</div>
                </div>
  ...
  function crystalFacetPaletteForComponent(index, colors, data, icePalette) {
    ...
    if (colorMode === "ice") return icePalette;
    const theme = crystalPalette(data);
