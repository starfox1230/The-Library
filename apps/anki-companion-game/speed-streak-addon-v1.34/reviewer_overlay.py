...
from .crystal_color_mode import CRYSTAL_COLOR_MODE_ICE, normalize_crystal_color_mode
...
ADDON_DISPLAY_NAME = "Speed Streak v1.34"
...
class ReviewerOverlayController:
    def __init__(self) -> None:
        ...
        self.crystal_color_mode = CRYSTAL_COLOR_MODE_ICE
    ...
    def _claim_time_boost_shortcut(self) -> None:
        if getattr(mw, "state", "") != "review":
            return
    ...
    def _load_persisted_settings(self) -> None:
        ...
        try:
            ...
            self.crystal_color_mode = normalize_crystal_color_mode(
                config.get("crystal_color_mode", CRYSTAL_COLOR_MODE_ICE)
            )
            if self.visual_mode == VISUAL_MODE_LIGHTWEIGHT_ROWS:
                self.render_mode = RENDER_MODE_ULTRA_LOW_RESOURCE
            elif self.visual_mode == VISUAL_MODE_CRYSTAL_REACTOR:
            ...
            self.engine.update_gameplay_settings(
                gameplay_mode=str(config.get("gameplay_mode", GAMEPLAY_MODE_LEGACY)),
            ...
            self.engine.update_gameplay_settings(
                gameplay_mode=GAMEPLAY_MODE_LEGACY,
                no_pause_mode=False,
                no_undo_mode=False,
                show_focus_mode_toggles=True,
                boost_seconds=5,
