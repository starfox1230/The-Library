...
class WhatsNewDialog(QDialog):
    def __init__(self, parent: Optional[QWidget] = None) -> None:
        ...
        content.addWidget(_label("Hypernova", body, size=25, color="#a5f3fc", weight=700))
        content.addWidget(_label("Build a hypernova from a quiet seed. Every answer adds a lasting colored segment, and neighboring rings rotate in opposite directions. Every ten completes a ring and unlocks another layer. Earn stars, plasma arms, a corona, and polar jets as you progress toward a hundred cards. The default Smooth setting targets 60 FPS.", body))
        content.addWidget(_label("Select Hypernova in Settings → Visuals or from the visual icon beneath the animation. Still, Smooth, and Rich settings keep the drawing budget bounded. Your current visual stays selected.", body, size=10))
