...
This folder contains the Speed Streak v1.16 version of the project packaged as an Anki add-on.
...
3. Close Anki.
4. In the folder that opens, create a new folder named `speed_streak_v1_16`.
...
`v1.16` keeps the `Brick Layout` visual mode and also serves as the comparison build for the external-window layout experiment.
