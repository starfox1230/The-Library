# Speed Streak 2.03 macOS haptics validation candidate

This folder contains the Speed Streak 2.03 validation candidate, based on the completed 2.02 release.
...
- Adds a polished one-time What’s New guide led by Time Boost, its No Pause/No Undo focus rules, and exact directions to every related control; a permanent Speed Streak menu item reopens it later.
...
3. Close Anki.
4. In the folder that opens, create a new folder named `speed_streak_v2_03`.
...
Version 2.03 includes the completed 2.02 work plus the gated native macOS haptics validation candidate.
