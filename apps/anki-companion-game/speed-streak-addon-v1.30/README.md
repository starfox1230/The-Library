...
This folder contains Speed Streak v1.30, built directly from v1.28. It intentionally does not include the experimental v1.29 animation throttling.
...
3. Close Anki.
4. In the folder that opens, create a new folder named `speed_streak_v1_30`.
...
`v1.30` keeps the v1.28 Sphere and Brick modes and adds the star-selected Crystal Reactor visual.
