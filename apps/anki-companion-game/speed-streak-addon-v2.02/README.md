...
This folder contains the Speed Streak 2.02 release, based on the completed 2.0 release.
...
3. Close Anki.
4. In the folder that opens, create a new folder named `speed_streak_v2_02`.
...
Version 2.02 includes the completed 2.0/2.01 work plus the non-blocking Auto-Pause Time Drains mode.
