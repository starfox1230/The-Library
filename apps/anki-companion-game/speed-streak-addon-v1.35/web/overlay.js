(function () {
  ...
  const VISUAL_COLOR_FIELDS = [
    { key: "core", label: "Sphere: Central Orb", description: "Only the Sphere's central orb, rings, and related glow." },
  ...
  function ensureMounted() {
    ...
    if (windowPresetsRoot) {
      windowPresetsRoot.addEventListener("pointerenter", cancelWindowPresetClose);
