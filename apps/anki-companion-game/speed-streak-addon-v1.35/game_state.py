...
class CompanionState:
    ...
    gameplay_mode: str = GAMEPLAY_MODE_LEGACY
...
class CompanionGameEngine:
    ...
    def reset_settings_to_defaults(self) -> str:
        ...
        s.gameplay_mode = GAMEPLAY_MODE_LEGACY
    ...
    def can_use_time_boost(self) -> bool:
        ...
        if (
            ...
            or s.paused
            or s.first_card_free
            or s.current_timer_policy_mode == TIMER_POLICY_NO_TIMEOUT
            or s.phase_limit_ms <= 0
            or s.phase_start_epoch_ms <= 0
            or s.boost_charges <= 0
        ):
            return False
        return self._phase_elapsed_ms() < s.phase_limit_ms
    ...
    def _normalize_gameplay_mode(self, value: object) -> str:
        normalized = str(value or GAMEPLAY_MODE_LEGACY).strip().lower()
