...
This folder contains Speed Streak v1.35, built directly from v1.34 without modifying the frozen v1.34 folder.
...
3. Close Anki.
4. In the folder that opens, create a new folder named `speed_streak_v1_35`.
...
`v1.35` keeps the v1.34 visuals and gameplay while reorganizing the Settings window into focused pages.
