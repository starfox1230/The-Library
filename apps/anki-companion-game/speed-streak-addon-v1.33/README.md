...
This folder contains Speed Streak v1.33, built directly from v1.32 without modifying the frozen v1.32 folder.
...
3. Close Anki.
4. In the folder that opens, create a new folder named `speed_streak_v1_33`.
...
`v1.33` keeps the v1.32 Sphere, Brick, and Crystal Reactor visuals while consolidating their controls.
