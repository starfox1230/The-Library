...
This folder contains the Speed Streak v1.11 version of the project packaged as an Anki add-on.
...
3. Close Anki.
4. In the folder that opens, create a new folder named `speed_streak_v1_11`.
