...
class NoteTypePickerDialog(QDialog):
    def __init__(
        ...
        select_visible = QPushButton("Select Visible", self)
        clear_visible = QPushButton("Clear Visible", self)
...
class SettingsDialog(QDialog):
    ...
    def _build_absolute_special_timers(self, parent: QWidget, layout: QVBoxLayout) -> None:
        ...
        note_types_panel = QFrame(parent)
        note_types_panel.setProperty("class", "settingRow")
        note_types_panel_layout = QVBoxLayout(note_types_panel)
        note_types_panel_layout.setContentsMargins(12, 12, 12, 12)
        ...
        add_note_type_button = QPushButton("Add Note Type Rule", note_types_panel)
    ...
    def _build_absolute_timer_rule_panel(
        ...
        *,
        ...
        if rule_key == "tag":
            ...
            save_tag_button = QPushButton("Save Tag", panel)
            ...
            choose_button = QPushButton("Choose Note Types...", panel)
