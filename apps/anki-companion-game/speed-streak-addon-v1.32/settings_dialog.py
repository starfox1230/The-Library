...
class SettingsDialog(QDialog):
    ...
    def _build_gameplay_panel(self, parent: QWidget) -> QWidget:
        ...
        layout.addWidget(
            self._build_toggle_block(
                ...
                "Includes inactive No Pause and No Undo controls in the panel that expands when you hover over or focus the Time Boost charges. Active controls are always included.",
            )
        )
    ...
    def _build_appearance_section(self, parent: QWidget) -> QWidget:
        ...
        color_button = ModernButton("Customize Orb Colors", frame)
    ...
    def focus_time_boost_settings(self) -> None:
        field = self.max_boost_charges_spin
    ...
    *,
    ...
    if _dialog is not None:
        try:
            ...
            elif time_boost_settings:
                _dialog.focus_time_boost_settings()
            return
        except Exception:
            try:
                _dialog.close()
