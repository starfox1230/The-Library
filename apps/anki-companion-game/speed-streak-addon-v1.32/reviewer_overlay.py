...
ADDON_DISPLAY_NAME = "Speed Streak v1.32"
...
class ReviewerOverlayController:
    ...
    def on_js_message(self, handled: tuple[bool, Any], message: str, context: Any) -> tuple[bool, Any]:
        ...
        if message.startswith("speed-streak:open-settings:shortcut:"):
            ...
            return (True, None)
        if message == "speed-streak:open-settings:gameplay:time-boost":
            self._open_settings_dialog(time_boost_settings=True)
            return (True, None)
    ...
    def _open_settings_dialog(
        ...
        *,
        shortcut_key: str = "",
        time_boost_settings: bool = False,
    ) -> None:
        ...
        open_settings_dialog(
            ...
            time_boost_settings=time_boost_settings,
        )
