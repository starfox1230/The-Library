...
def normalize_render_mode(value: object) -> str:
    ...
    if normalized in {RENDER_MODE_WEBGL, RENDER_MODE_CLASSIC, RENDER_MODE_LOW_RESOURCE, RENDER_MODE_ULTRA_LOW_RESOURCE}:
        return normalized
    return RENDER_MODE_WEBGL
