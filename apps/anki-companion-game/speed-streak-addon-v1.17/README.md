...
This folder contains the Speed Streak v1.17 version of the project packaged as an Anki add-on.
...
3. Close Anki.
4. In the folder that opens, create a new folder named `speed_streak_v1_17`.
...
`v1.17` keeps the `Brick Layout` visual mode and adds the optional deck-page Review Later count button.
