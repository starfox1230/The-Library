...
This folder contains Speed Streak v1.31, built directly from the current v1.30 work and retaining its Crystal Reactor visual.
...
3. Close Anki.
4. In the folder that opens, create a new folder named `speed_streak_v1_31`.
...
`v1.31` keeps the v1.28 Sphere and Brick modes and the star-selected Crystal Reactor visual.
