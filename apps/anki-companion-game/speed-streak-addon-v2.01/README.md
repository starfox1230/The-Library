...
This folder contains the Speed Streak 2.01 release, based on the completed 2.0 release.
...
3. Close Anki.
4. In the folder that opens, create a new folder named `speed_streak_v2_01`.
...
Version 2.01 includes the completed Time Boost, visual, performance, and settings work from 2.0, plus Anki review-shortcut conflict warnings.
