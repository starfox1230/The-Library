(function () {
  ...
  function computeTimer(data) {
    ...
    if (free) {
      return { visible: true, free: true, untimed: false, phase, paused: false, remaining: 0, total: 0, secondsText: "0.0" };
    }
    if (untimed && !limit) {
      return { visible: true, free: false, untimed: true, phase, paused: false, remaining: 0, total: 0, secondsText: "0.0" };
    }
    if (!limit) {
      return { visible: true, free: true, untimed: false, phase, paused: false, remaining: 0, total: 0, secondsText: "0.0" };
    }
